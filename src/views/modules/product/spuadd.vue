                ...
                <el-form-item :label="attr.attrName" v-for="(attr,aidx) in dataResp.saleAttrs"
                  ...
                  <el-checkbox-group v-model="dataResp.tempSaleAttrs[aidx].attrValues">
                    ...
                    <div style="margin-left:20px;display:inline">
                      <el-button v-show="!inputVisible[aidx].view" class="button-new-tag"
                        size="mini" @click="showInput(aidx)">+自定义</el-button>
          ...
          <el-table :data="spu.skus" style="width: 100%">
            <el-table-column label="属性组合">
              <el-table-column :label="item.attrName"
                v-for="(item,index) in dataResp.tableAttrColumn" :key="item.attrId">
