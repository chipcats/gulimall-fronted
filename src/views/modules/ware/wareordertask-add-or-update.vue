...
export default {
  data() {
    return {
      ...
      dataRule: {
        orderId: [{ required: true, message: "order_id不能为空", trigger: "blur" }],
        orderSn: [{ required: true, message: "order_sn不能为空", trigger: "blur" }],
        consignee: [{ required: true, message: "收货人不能为空", trigger: "blur" }],
        consigneeTel: [{ required: true, message: "收货人电话不能为空", trigger: "blur" }],
        deliveryAddress: [{ required: true, message: "配送地址不能为空", trigger: "blur" }],
        orderComment: [{ required: true, message: "订单备注不能为空", trigger: "blur" }],
        paymentWay: [
          {
            required: true,
        ...
        orderBody: [{ required: true, message: "订单描述不能为空", trigger: "blur" }],
        trackingNo: [{ required: true, message: "物流单号不能为空", trigger: "blur" }],
        createTime: [{ required: true, message: "create_time不能为空", trigger: "blur" }],
        wareId: [{ required: true, message: "仓库id不能为空", trigger: "blur" }],
        taskComment: [{ required: true, message: "工作单备注不能为空", trigger: "blur" }],
      },
    };
  },
  methods: {
