...
export default {
  data() {
    return {
      ...
      dataRule: {
        levelId: [{ required: true, message: "会员等级id不能为空", trigger: "blur" }],
        ...
        sign: [{ required: true, message: "个性签名不能为空", trigger: "blur" }],
        sourceType: [{ required: true, message: "用户来源不能为空", trigger: "blur" }],
        integration: [{ required: true, message: "积分不能为空", trigger: "blur" }],
